...
/**
 * Guia do acervo da Daddus. A montagem e os metadados vivem em
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  return publishMetadata(PublishCategories.GUIDES, params.slug);
}

export default async function Page({ params }: PageProps) {
  return renderPublishPage(PublishCategories.GUIDES, params.slug);
}
