"use client";
import { constantsProjectModeling } from "./_constants";
  ...
  return (
    <div className="flex flex-1 flex-col">
        <div
            ...
            className="flex flex-col lg:flex-row w-full h-full py-[4%] px-[9%]  gap-[2%] lg:gap-[5%] "
        >
            <div id="left" className="flex lg:w-1/2 flex-col">
                {constantsProjectModeling.content.map((item, index) => (
                    <div
                    ...
                    >
                        ...
                        {item.listConsultancy && (
                            <div>
                                <ol className={`list-${item.type}`}>
                                    {item.listConsultancy.map((item, index) => (
                                        <li key={`list-consultancy-elaboration-policy-page`} className="text-[17px] text-[#696984] ml-[5%]">  
                                            <p className="flex text-justify text-[17px] text-[#696984] leading-loose whitespace-pre-line ">
                                                {item}
                                            </p>
                                        </li>
            ...
            >
                <Image
                    src={constantsProjectModeling.image.src}
                    width={450}
                    height={300}
                    alt={constantsProjectModeling.image.alt}
                />
        ...
        <div id="bottom-transport-page" className="px-[7%]">
            ...
            {constantsProjectModeling.footer.title}
            </h2>
            ...
            <div className="flex flex-col lg:flex-row gap-10 lg:h-[500px] 2xl:h-[500px] pb-20 md:justify-center md:items-center lg:justify-start lg:items-start">
                {constantsProjectModeling.footer.cards.map((item, index) => (
