  ...
  return (
    <div className="flex flex-1 flex-col">
      <div
        ...
        className="flex flex-col w-full md:w-[70%] h-full py-[2%] px-[9%] mb-[2%] gap-[2%] lg:gap-[10%] "
      >
        <h2 className="font-bold text-[26px] lg:text-[32px] text-[#A90920] mb-[2%] mt-[5%]">
          {constantsTermsOfUse.title}
        </h2>
        <p className="flex text-justify text-[15px] text-[#696984] leading-loose whitespace-pre-line ">
          {constantsTermsOfUse.text1}
        </p>
        <br />
        <p className="flex text-justify text-[15px] text-[#696984] leading-loose whitespace-pre-line ">
          {constantsTermsOfUse.titleDeclaration}
        </p>
        <br />
        <ol className="list-decimal text-justify text-[15px] text-[#696984] leading-loose whitespace-pre-line">
          {constantsTermsOfUse.declarations.map((item, index) => (
            <li className="ml-[3%]" key={`item-declaration-${index}`}>
              {item}
            </li>
          ))}
        </ol>
        ...
        <ol className="list-decimal text-justify text-[15px] text-[#696984] leading-loose whitespace-pre-line">
          ...
          {constantsTermsOfUse.topics.map((item, index) => {
            ...
            return (
              <div key={`terms-of-use-topic-${index}`}>
                <li className="ml-[3%]" key={`item-declaration-${index}`}>
                  {item.title}
                </li>
                <br />
                <p className="flex text-justify text-[15px] text-[#696984] leading-loose whitespace-pre-line ">
                  {item.textBeforeSubList}
                </p>
                <br />
                {item.sublist && (
                  <div>
