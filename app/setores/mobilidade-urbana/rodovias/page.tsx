    ...
    <div className="flex flex-1 flex-col">
      ...
      >
        <div id="left" className="flex lg:w-1/2 flex-col">
          {constantsHighways.content.map((item, index) => (
            <div
        ...
        >
          <Image
            src="/images/setores/rodovias.jpg"
            width={450}
            height={300}
            sizes="(max-width: 1024px) 100vw, 450px"
            className="h-auto w-full rounded-2xl object-cover"
            alt="Vista aérea de um trevo rodoviário em Londrina, no Paraná, com caminhão e fila de veículos nos acessos."
          />
      ...
      <div id="bottom-transport-page" className="px-[7%]">
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:h-[70%] md:justify-center md:items-center lg:justify-start lg:items-start">
          {constantsHighways.cards.map((item, index) => (
            <div key={`card-highways-page-${index}`} className="flex flex-col lg:flex-row gap-10  md:max-w-[70%] lg:max-w-[33%] mb-4 lg:mb-14 mt-[3%] rounded-3xl shadow-xl">
              <CardInfo
                title={item.title}
