  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      >
        ...
        >
          <Image
            src="/images/setores/transportes.jpg"
            width={450}
            height={300}
            sizes="(max-width: 1024px) 100vw, 450px"
            className="h-auto w-full rounded-2xl object-cover"
            alt="Ônibus da rede municipal de Curitiba em ponto de parada, com passageiros e o símbolo de acessibilidade na lateral."
          />
