    ...
    <div className="flex flex-1 flex-col">
      ...
      >
        <div id="left" className="flex lg:w-1/2 flex-col">
          {constantsPorts.content.map((item, index) => (
            <div
      ...
      <div id="bottom-transport-page" className="px-[7%]">
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:h-[70%] md:justify-center md:items-center lg:justify-start lg:items-start">
          {constantsPorts.cards.map((item, index) => (
              <div key={`card-info-ports-page-${index}`} className="flex flex-col lg:flex-row gap-10  md:max-w-[70%] lg:max-w-[33%] mb-4 lg:mb-14 mt-[3%] rounded-3xl shadow-xl">
                <CardInfo
                  title={item.title}
