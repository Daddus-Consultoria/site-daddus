'use client'
import {constantsPorts} from './_constants'
...
const PortsPage = () =>{
    ...
    return (
        <div className="flex flex-1 flex-col">
            <div id="top-transport-page" className="flex flex-col lg:flex-row w-full h-full py-[4%] px-[9%] mb-[2%] gap-[2%] lg:gap-[10%] ">
                <div id="left" className="flex lg:w-1/2 flex-col">
                    {constantsPorts.map((item, index) => (
                ...
                <div id="right" className="flex lg:w-1/2 flex-col justify-start items-end gap-[7%] ">
                    <Image src="/images/publications/bus.svg" width={450} height={300} alt='bus'/>
