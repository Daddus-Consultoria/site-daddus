        ...
        <div className="flex items-start justify-start m-[4%] rounded-2xl bg-[#EEEEEE] text-black">
            <div className="flex h-full w-full items-start justify-between ">
                <Image 
                    ...
                    className="-mt-[5%]  xl:ml-[3%] 3-xl:ml-[1%] h-[105%] w-full" 
                />
                <div className="flex flex-col h-[85%] gap-3 mx-[5%] my-[4%] justify-between">
                    <div className="flex flex-col gap-3">
                        <h2 className="font-bold text-[#A90920] text-[16px] text-justify">Citologia: um estudo demográfico de duas ou três linhas</h2>
                        <p className="text-[11px] text-justify">Ao contrário da crença popular, o Lorem Ipsum não é simplesmente texto aleatório. Tem raízes numa peça de literatura clássica em Latim, de 45 AC, tornando-o com mais de 2000 anos.</p>
                    </div>
